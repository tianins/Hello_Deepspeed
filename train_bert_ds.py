...
def create_data_iterator(
        ...
        tokenizer: str = "/data1/hqp_w/pre_train_model/roberta-large/",  # 改成本地路径
) -> InfiniteIterator:
    ...
    """
    local_dataset_path = "/data1/hqp_w/Hello_Deepspeed/wikitext-2-v1/wikitext-2/train/wikitext-103-raw-v1_test_0000.parquet"
    wikitext_dataset = datasets.load_dataset("wikitext-2-v1",
                                             split="train",
...
def train(
        ...
        # Dataset Parameters
        mask_prob: float = 0.15,  # 好奇怪啊，这里不是数字吗，怎么到后面变成字符串了？？？'$@' ？？？配置环境时打多了，这个应该要删掉的
    ...
    ###### Create Exp. Dir #########
    ################################
    # load_checkpoint_dir 不知道在哪里被初始化了
...
if __name__ == "__main__":
    import os
    os.environ["PATH"] = os.environ["PATH"] + "//home/ailab/.cache/torch_extensions/py38_cu117/"
